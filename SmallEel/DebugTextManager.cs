 ...
 * Create an instance of DebugTextManager, call its Write method to Write, UnWrite to unwrite, Clear to clear all messages. 
...
namespace SmallEel.DebuggingHelpers
{
